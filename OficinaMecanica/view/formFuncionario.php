...
<div class="container py-5">
  <div class="card shadow-sm">
    <div class="card-header bg-dark text-white">
      <h3 class="mb-0">
        <?= isset($funcionario) ? 'Editar' : 'Cadastrar'; ?>
      </h3>
    </div>

    <div class="card-body">
      <form
        action="funcionario.php"
        method="post"
      ...
      >
        ...
        <input
          type="hidden"
          name="acao"
          value="<?= isset($funcionario) ? 'atualizar' : 'cadastrar'; ?>"
        />
        ...
        <div class="col">
          ...
          <input
            ...
            placeholder="Informe a função do funcionário"
            required
          />
        </div>
        ...
        <div class="col">
          ...
          class="form-control"
          value="<?= isset($funcionario['data_de_nascimento']) ? date('Y-m-d', strtotime($funcionario['data_de_nascimento'])) : ''; ?>"
          required
          />
        </div>
        ...
        <div class="col-12 pt-3">
          ...
          <a href="funcionario.php" class="btn btn-secondary ms-1">
